...
public class LPex4 {
   ...
   internal class MyCallback : Cplex.ContinuousCallback {
      public override void Main() {
         System.Console.Write("Iteration " + GetNiterations() + ": ");
         if ( IsFeasible() )
            System.Console.WriteLine("Objective = " + GetObjValue());
         else
            System.Console.WriteLine("Infeasibility measure = " + GetInfeasibility());
      }
   }
